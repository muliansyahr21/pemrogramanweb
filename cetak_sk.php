            ...
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<h5 class="up" id="nama">LAPORAN SURAT KELUAR</h5><br/>';
                        echo '<h6 class="status">'.$status.'</h6>';
                        echo '<span id="alamat">Jalan Raya Seturan</span>';
                ...
                echo '
                    <table class="bordered" id="tbl">
                        ...
                        <a><br></a>
                            <tr>
                                <td class="tgh" id="lbr" colspan="5">'.$no++.'</td>
                            </tr>
                                        ...
                                        <td>'.substr($row['isi'],0,200).'<br/><br/></td>
                                        <td>'.$row['tujuan'].'</td>
