                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                                ...
                                                if($result > 0){
                                                    ...
                                                    if($file != ""){
                                                            ...
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,indeks,tgl_surat,
                                                                    tgl_diterima,file,keterangan,id_user)
                                                                        VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$indeks','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,indeks,tgl_surat, tgl_diterima,file,keterangan,id_user)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$indeks','$tgl_surat',NOW(),'','$keterangan','$id_user')");
